...
const DVA_CLIENT_RELEASE = "electric-long-range-settlement-v558";
...
const GENERATED_ITEM_TEXTURE_CACHE_VERSION = "electric-long-range-settlement-v558";
...
const version = "electric-long-range-settlement-v558";
...
function registerServiceWorker() {
  ...
  navigator.serviceWorker.register(new URL("sw.js?v=electric-long-range-settlement-v558", document.baseURI)).catch(() => {});
}
